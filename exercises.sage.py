...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_11 = Integer(11); _sage_const_7171 = Integer(7171)#x = var('x')
...
print(CRT_list([_sage_const_1 , _sage_const_2 , _sage_const_2 ], [_sage_const_3 , _sage_const_11 , _sage_const_7171 ])) # 78883
